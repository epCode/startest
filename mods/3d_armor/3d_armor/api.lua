...
armor = {
	...
	materials = {
		wood = "group:wood",
		cactus = "sw_core_items:sand_desert_light_packed",
		steel = "sw_core_items:sand_desert_light_packed",
		bronze = "sw_core_items:sand_desert_light_packed",
		diamond = "sw_core_items:sand_desert_light_packed",
		gold = "sw_core_items:sand_desert_light_packed",
