multidimensions.register_dimension=function(name,def,self)
	...
	def.self.stone = def.stone or "sw_core_items:stone"
	def.self.dirt = def.dirt or "sw_core_items:dirt"
	def.self.grass = def.grass or "sw_core_items:dirt_with_grass"
	def.self.air = def.air or "air"
	def.self.water = def.water or "sw_core_items:water_source"
	def.self.sand = def.sand or "sw_core_items:sand"
	def.self.bedrock = def.bedrock or "sw_core_items:bedrock"
