...
local function num_to_color(num)
	num2 = tonumber(num)
	local color = "#000000"
	if num2 > 50 then
		color = "#0076ff"
...
sfinv.register_page("sfinv:crafting", {
	...
	get = function(self, player, context)
		...
		return sfinv.make_formspec(player, context,
				...
				"image[18.8,1.1;0.1,0.7;player_species_rodian.png^[colorize:"..num_to_color(meta:get("repGAMEminingguild"))..":255]"..
				...
				"image[18.8,2.1;0.1,0.7;player_species_rodian.png^[colorize:"..num_to_color(meta:get("repGAMEtransportguild"))..":255]"..
				...
				"image[18.8,3.1;0.1,0.7;player_species_rodian.png^[colorize:"..num_to_color(meta:get("repGAMEtheempire"))..":255]"..
				...
				"image[18.8,4.1;0.1,0.7;player_species_rodian.png^[colorize:"..num_to_color(meta:get("repGAMErebels"))..":255]"..
				...
				"image[18.8,5.1;0.1,0.7;player_species_rodian.png^[colorize:"..num_to_color(meta:get("repGAMEbounty"))..":255]"..
